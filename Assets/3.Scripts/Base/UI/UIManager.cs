...
public class UIManager : BaseSingleton<UIManager>
{
    ...
    public UIManager()
    {
        ...
        ResMgr.GetInstance().Load<GameObject>(PathCfg.UI_CANVAS,(obj)=> {
        ...
        ResMgr.GetInstance().Load<GameObject>(PathCfg.UI_SYSTEM,(obj)=> {
            var instance = MonoMgr.GetInstance().InstantiateObj(obj.Result);
            GameObject.DontDestroyOnLoad(instance);
    ...
    public void ShowPanel<T>(string panelName,E_UI_Layer layer = E_UI_Layer.Mid, UnityAction<T> callBack = null) where T:BasePanel
    {
        ...
        //更新为云端的时候去掉了PathCfg.PATH_UI + 
        ResMgr.GetInstance().LoadAsync<GameObject>(panelName, (obj) => {
            //把他作为Canvas的子对象
            //并且要设置它的相对位置
            //找到父对象 你到底显示在那一层
