public static class PathCfg 
{
    ...
    //---------------------场景物体对应的物体资源
    public static string PATH_OBJECT_ORIGINAL_CUBE = "Prefabs/Original_Cube";
    
    //----------------------AI
    public static string PATH_AI_ENEMY = "Prefabs/Player";
    //--------------------------文件 文件保存位置
    ...
    //---------------------------UI Message
    public static string PREFAB_PANEL_MESSAGE = "Message";

    //-------------------------UI BaseController
    public static string PREFAB_PANEL_BASECONTROLLER = "BaseController";

    //------------------------UI Joystick
    public static string PREFAB_PANEL_DYNAMICJOYSTICK = "Dynamic Joystick";

    //------------------------UI MenunOnGaming
    public static string PREFAB_PANEL_MENUONGAMING = "MenuOnGaming";
